...
public class TransactionTest extends BaseTest {
    ...
    private void createAccount(String name, String balance) throws InterruptedException {
        ...
        Thread.sleep(500);
        driver.findElement(AppiumBy.accessibilityId("field_account_name")).sendKeys(name);
        driver.findElement(AppiumBy.accessibilityId("field_account_balance")).sendKeys(balance);
        driver.findElement(AppiumBy.accessibilityId("btn_save_account")).click();
        Thread.sleep(1000);
        driver.findElement(AppiumBy.accessibilityId("nav_dashboard")).click();
        Thread.sleep(500);
    }
    ...
    public void testCreateIncomeTransaction() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.accessibilityId("nav_add_transaction")).click();
        Thread.sleep(1000);

        driver.findElement(AppiumBy.accessibilityId("chip_type_income")).click();
        Thread.sleep(500);

        driver.findElement(AppiumBy.accessibilityId("field_amount")).sendKeys("500000");

        driver.findElement(AppiumBy.accessibilityId("dropdown_account")).click();
        Thread.sleep(500);
        driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text='Main Wallet']")).click();

        driver.findElement(AppiumBy.accessibilityId("chip_category_Salary")).click();
        Thread.sleep(500);

        driver.findElement(AppiumBy.accessibilityId("field_note")).sendKeys("Test income");
        driver.findElement(AppiumBy.accessibilityId("btn_save_transaction")).click();
        Thread.sleep(1000);
    ...
    public void testCreateExpenseTransaction() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.accessibilityId("chip_type_expense")).click();
        Thread.sleep(500);

        driver.findElement(AppiumBy.accessibilityId("field_amount")).sendKeys("50000");

        driver.findElement(AppiumBy.accessibilityId("dropdown_account")).click();
        Thread.sleep(500);
        driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text='Expense Wallet']")).click();

        driver.findElement(AppiumBy.accessibilityId("chip_category_Food & Drinks")).click();
        Thread.sleep(500);

        driver.findElement(AppiumBy.accessibilityId("field_note")).sendKeys("Test expense");
        driver.findElement(AppiumBy.accessibilityId("btn_save_transaction")).click();
        Thread.sleep(1000);
    ...
    public void testInsufficientBalanceExpense() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.accessibilityId("field_amount")).sendKeys("999999");
    ...
    public void testEditTransaction() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.accessibilityId("chip_type_income")).click();
        driver.findElement(AppiumBy.accessibilityId("field_amount")).sendKeys("100000");
        ...
        driver.findElement(AppiumBy.accessibilityId("nav_analytics")).click();
        Thread.sleep(1000);
        ...
        driver.findElement(AppiumBy.accessibilityId("field_amount")).clear();
        driver.findElement(AppiumBy.accessibilityId("field_amount")).sendKeys("200000");
        driver.findElement(AppiumBy.accessibilityId("btn_save_changes")).click();
        Thread.sleep(1000);
    ...
    public void testDeleteTransaction() throws InterruptedException {
        ...
        driver.findElement(AppiumBy.accessibilityId("btn_delete_transaction")).click();
        Thread.sleep(500);

        driver.findElement(AppiumBy.accessibilityId("btn_confirm_delete")).click();
        Thread.sleep(1000);
